...
1.  **Fork and clone**
    ...
    Clone thir repository to your local PC

    ```sh
    # clone
    git clone git@github.com:fossildev/www.git
    ```

1.  **Start developing.**

    Navigate into FOSSIL site’s directory and start it up.
...
1.  **Open the source code and start editing!**
    ...
    Open the `www` directory in your code editor of choice and edit `src/pages/index.js`. Save your changes and the browser will update in real time!
